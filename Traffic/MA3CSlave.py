...
from Traffic.MA3CNetwork import AC_Network
...
class Worker:
    ...
    def train_weights_and_get_comm_gradients(self, rollout, sess, gamma, ac_network, bootstrap_value=0):
        ...
        """for o, m, a, r, v, advs in zip(observations, mess_received, actions, rewards, values, advantages):
            print(o, m, a, r, v, advs)
        print()
        exit()"""
    ...
    def apply_comm_gradients(self, observations, mess_received, message_sent, message_loss, sess, ac_network):
        # print(observations[0], mess_received[0], message_sent[0], message_loss[0])
        # print(observations[1], mess_received[1], message_sent[0], message_loss[0])
    ...
    def input_mloss_to_output_mloss(self, batch_size, mgrad_per_received, comm_map):
        # print(mgrad_per_received[0][0], comm_map[0][0])
        # print(mgrad_per_received[1][0], comm_map[1][0])
