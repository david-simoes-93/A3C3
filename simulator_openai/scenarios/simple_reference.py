import numpy as np
from simulator_openai.core import World, Agent, Landmark
from simulator_openai.scenario import BaseScenario
...
class Scenario(BaseScenario):
    ...
    def observation(self, agent, world):
        ...
        #print([agent.state.p_vel],entity_pos,goal_color[1])
