...
state_size_prey = 11
s_size_central_prey = 22
action_size_prey = 5
number_of_agents_prey = 1
comm_size_prey = 0
...
with tf.device("/cpu:0"):
    ...
    master_network_prey = AC_Network(state_size_prey, s_size_central_prey, number_of_agents_prey, action_size_prey,
                                (number_of_agents - 1) * comm_size_prey,
                                (number_of_agents - 1) * comm_size_prey if spread_messages else comm_size_prey, 'global_prey',
                                None, critic_action=critic_action, critic_comm=critic_comm)  # Generate global network

    workers = []
    # Create worker classes
    for i in range(FLAGS.num_slaves):
        workers.append(Worker(make_env("simple_reference"), i, state_size, s_size_central,
