...
from FCPPassing.MA3CNetwork import AC_Network
from FCPPassing.MA3CSlave import Worker
from simulator_fcp.GymFCPPassing import GymFCPPassing, gym_fcp_kill_all
from simulator_fcp.Scenario import Passing
...
s_size_central = [8]
action_size = 5
env = GymFCPPassing(scenario=Passing(), serverports=[3100+FLAGS.task_index*1000, 3200+FLAGS.task_index*1000])
critic_action = False
critic_comm = False
